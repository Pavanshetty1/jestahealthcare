...
function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Contact Jesta Healthcare for medical products, hospital supplies, surgical products, diagnostic products and bulk healthcare product enquiries."
        canonical="/contact"
      />
